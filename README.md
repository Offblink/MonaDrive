...
- **文件管理器** — 内置侧边栏，添加/删除/重命名文件，悬停显示操作按钮，↻ 刷新文件列表并检查远端更新
...
5. **状态栏** — 实时显示 "N 文件已修改" / "N 个新文件" / "本地领先 N 提交" / "落后 N 提交"；切回窗口自动刷新
6. **托盘后台** — 关闭窗口后程序仍在后台运行，右键托盘图标可退出
...
- 关闭窗口默认最小化到系统托盘，右键托盘图标选"退出"彻底关闭
