...
_translations = {
    "en": {
        ...
        "dash.checking_remote": "Checking remote status...",
        ...
        "help.body": (
            ...
            "  - Status bar shows local ahead/behind remote commit counts, auto-refreshes on window focus\n"
            "  - Click the refresh button (\u21bb) to re-scan files and check remote status\n"
    ...
    "zh": {
        ...
        "help.body": (
            ...
            "  - 点击拉取从远端覆盖本地文件\n"
            "  - 状态栏实时显示本地领先/落后远端提交数，切回窗口自动刷新\n"
            "  - 点击刷新按钮 (\u21bb) 重新扫描文件并检查远端状态\n"
            "  - 拖放文件或文件夹到窗口即可添加\n"
            "  - 悬停文件或仓库可显示重命名/删除按钮\n"
            "  - 点击加载动画可取消正在进行的同步\n"
            "  - 初始化不会自动拉取远端文件\n"
